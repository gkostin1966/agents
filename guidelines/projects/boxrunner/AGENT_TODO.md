# AGENT_TODO — boxwalker

## Resuming a session

1. Check working state: `git branch --show-current | cat` and `git --no-pager status | cat`
2. Read `AGENTS.md` (project rules) and `AGENTS_ROOT/guidelines/projects/boxwalker/AGENTS.md`.
3. Read the top entry of `AGENT_DONE.md` for recent completion context.
