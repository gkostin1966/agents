# .agents/scripts Conventions — dspace-containerization

This directory is for project-local agent helper scripts when working in `mounted-projects/dspace-containerization`.
