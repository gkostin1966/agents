...
Writes the draft to .agents/emails/its-oidc-request.rtf (i.e. the emails/
directory adjacent to this dotpy/ directory).
"""
...
# Writes to .agents/emails/ (sibling of this dotpy/ directory)
