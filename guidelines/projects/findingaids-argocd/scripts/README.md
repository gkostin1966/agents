# .agents/scripts Conventions — findingaids-argocd

This directory is for project-local agent helper scripts when working in `mounted-projects/findingaids-argocd`.
