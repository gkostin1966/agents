...
- [x] Verify with the developer that migration is complete and project root is clean

## 2026-07-22 — Prune dspace-angular duplicated guidance and temporary artifacts

- [x] Remove temporary tracked artifact files from `guidelines/projects/dspace-angular/`
- [x] Replace verbose duplicated guidance files with concise project-specific summaries
- [x] Regenerate project merged outputs for `dspace-angular`
- [x] Verify with the developer that cleanup refactor is complete

## 2026-07-22 — Apply communications scaffold pattern to all mounted projects
...
- [x] Verify with the developer that scaffold rollout is complete

## 2026-07-22 — Add scaffold directory support for mounted projects
...
- [x] Verify with the developer that scaffold-directory support is complete
